...
bne StoreDamage @ if skill tester true, store damage
add r2, r1 @damagex3 if skill tester false
StoreDamage:
strh r2, [r7, #4] @final damage

@ check for zeke skill
mov r0,r4 @ attacker
ldr r1, =EyeOfShiningJusticeIDLink
ldrb r1, [ r1 ]
blh SkillTester,r3
cmp r0,#0 @ skill check
beq DunbanCheck

@ adds on damage for zeke skill
mov r1, #4
ldrsh r1, [r7, r1]
mov r2, r1
...
DunbanCheck: @ check for dunban skill
mov r0, r4 @attacker
ldr r1, =DunbanSkillIDLink
ldrb r1, [ r1 ]
blh SkillTester,r3
cmp r0,#0 @ skill check
bne SetCritHPDrainFlag
